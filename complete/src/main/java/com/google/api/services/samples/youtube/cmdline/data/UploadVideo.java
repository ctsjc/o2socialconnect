...
public class UploadVideo {
    ...
    public static void main(String[] args) {
        ...
        new UploadVideo().uploadVideotoYT("sample-12.mp4","/home/cts1/projects/gs-handling-form-submission/complete/src/main/resources/sample-video.mp4","custom Title");
    }

    public void uploadVideotoYT(String filename, String path,String title){
        ...
        try {
            ...
            snippet.setDescription(
                    "This is description " + "on " + cal.getTime());
